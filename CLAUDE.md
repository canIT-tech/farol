...
- ~~**`.github/workflows/ci.yml` sem as envs novas.**~~ Resolvido no Passo 6: o bloco `env:` agora declara `SUPABASE_JWKS_URL`, `ANTHROPIC_API_KEY`, `AMADEUS_CLIENT_ID/SECRET`, `GOOGLE_PLACES_KEY` e `JOBS_SCHEMA`.
